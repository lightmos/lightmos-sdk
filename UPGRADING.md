...
## [v0.47.x](https://github.com/lightmos/lightmos-sdk/releases/tag/v0.47.0)
...
The `simapp` package **should not be imported in your own app**. Instead, you should import the `runtime.AppI` interface, that defines an `App`, and use the [`simtestutil` package](https://pkg.go.dev/github.com/lightmos/lightmos-sdk/testutil/sims) for application testing.
...
This means that modules are injected directly into SimApp thanks to a [configuration file](https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/simapp/app_config.go).
The previous behavior, without the dependency injection framework, is still present in [`app.go`](https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/simapp/app.go) and is not going anywhere.
...
* [issue #14949 on cosmos-sdk](https://github.com/lightmos/lightmos-sdk/issues/14949)
...
This is to allow the proto FileDescriptSets to be correctly registered, and this standardized OS import paths allows [Hubl](https://github.com/lightmos/lightmos-sdk/tree/main/tools/hubl) to reflectively talk to any chain.
...
The `params` module will be removed in `v0.48`, as mentioned [in v0.46 release](https://github.com/lightmos/lightmos-sdk/blob/v0.46.1/UPGRADING.md#xparams). It is strongly encouraged to migrate away from `x/params` before `v0.48`.
...
import (
	...
	v4 "github.com/lightmos/lightmos-sdk/x/gov/migrations/v4"
