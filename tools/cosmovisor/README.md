...
You can download Cosmovisor from the [GitHub releases](https://github.com/lightmos/lightmos-sdk/releases/tag/cosmovisor%2Fv1.3.0).
...
```shell
go install github.com/lightmos/lightmos-sdk/cosmovisor/cmd/cosmovisor@v0.1.0
```
...
Next, we can add a migration - which is defined using `x/upgrade` [upgrade plan](https://github.com/lightmos/lightmos-sdk/blob/main/docs/core/upgrade.md) (you may refer to a past version if you are using an older Cosmos SDK release). In a migration we can do any deterministic state change.
