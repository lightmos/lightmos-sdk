...
* [`/baseapp`](https://github.com/lightmos/lightmos-sdk/tree/main/baseapp)
* [`/crypto`](https://github.com/lightmos/lightmos-sdk/tree/main/crypto)
* [`/types`](https://github.com/lightmos/lightmos-sdk/tree/main/types)
* [`/store`](https://github.com/lightmos/lightmos-sdk/tree/main/store)

### Modules

* [`x/auth`](https://github.com/lightmos/lightmos-sdk/tree/main/x/auth)
* [`x/bank`](https://github.com/lightmos/lightmos-sdk/tree/main/x/bank)
* [`x/capability`](https://github.com/lightmos/lightmos-sdk/tree/main/x/capability)
* [`x/staking`](https://github.com/lightmos/lightmos-sdk/tree/main/x/staking)
* [`x/slashing`](https://github.com/lightmos/lightmos-sdk/tree/main/x/slashing)
* [`x/evidence`](https://github.com/lightmos/lightmos-sdk/tree/main/x/evidence)
* [`x/distribution`](https://github.com/lightmos/lightmos-sdk/tree/main/x/distribution)
* [`x/mint`](https://github.com/lightmos/lightmos-sdk/tree/main/x/mint)
...
also recommend you to read the [specification](https://github.com/lightmos/lightmos-sdk/blob/main/docs/building-modules/README.md) of each module before digging into
the code.
...
* Tx signature verification (see [`x/auth/ante`](https://github.com/lightmos/lightmos-sdk/tree/main/x/auth/ante))
...
1. Patches are prepared in private repositories for eligible releases of Cosmos SDK. See [Stable Release Policy](https://github.com/lightmos/lightmos-sdk/blob/main/RELEASE_PROCESS.md#stable-release-policy) for a list of eligible releases.
