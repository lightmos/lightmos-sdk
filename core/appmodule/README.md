...
message Module {
  option (cosmos.app.v1alpha1.module) = {
    go_import: "github.com/lightmos/lightmos-sdk/x/auth"
  };
...
Alternatively, the `depinject.Config` can be created via [pure Go code](https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/simapp/app_config.go).
