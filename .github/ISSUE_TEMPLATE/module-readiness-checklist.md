...
- [ ] API audit (at least 1 person) (@assignee)
  ...
  - [ ] Is everything well documented (inline godoc as well as the spec [README.md](https://github.com/lightmos/lightmos-sdk/blob/main/docs/spec/SPEC-SPEC.md) in module directory)
