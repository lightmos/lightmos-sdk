...
[ADR-038](https://github.com/lightmos/lightmos-sdk/blob/main/docs/architecture/adr-038-state-listening.md)
and defined in [types/streaming.go](https://github.com/lightmos/lightmos-sdk/blob/main/baseapp/streaming.go).
