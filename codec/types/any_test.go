...
// See https://github.com/lightmos/lightmos-sdk/issues/8537
func TestNewAnyWithCustomTypeURLWithErrorNoAllocation(t *testing.T) {
	// This tests continues to fail inconsistently.
	//
	// Example: https://github.com/lightmos/lightmos-sdk/pull/9246/checks?check_run_id=2643313958#step:6:118
	// Ref: https://github.com/lightmos/lightmos-sdk/issues/9010
	t.SkipNow()
