...
const (
	...
	ormListPkg  = protogen.GoImportPath("github.com/lightmos/lightmos-sdk/orm/model/ormlist")
	ormErrPkg   = protogen.GoImportPath("github.com/lightmos/lightmos-sdk/orm/types/ormerrors")
	ormTablePkg = protogen.GoImportPath("github.com/lightmos/lightmos-sdk/orm/model/ormtable")
)
