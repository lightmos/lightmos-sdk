...
`x/evidence` is an implementation of a Cosmos SDK module, per [ADR 009](https://github.com/lightmos/lightmos-sdk/blob/main/docs/architecture/adr-009-evidence-module.md),
...
```protobuf reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/proto/cosmos/evidence/v1beta1/evidence.proto#L12-L32
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/evidence/keeper/infraction.go#L26-L140
```
