...
```protobuf reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/proto/cosmos/slashing/v1beta1/slashing.proto#L13-L35
```
...
```protobuf reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/proto/cosmos/slashing/v1beta1/slashing.proto#L37-L59
```
...
> be changed to jailed/unjailed. See issue [#3205](https://github.com/lightmos/lightmos-sdk/issues/3205)
