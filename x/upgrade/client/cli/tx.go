...
import (
	...
	"github.com/lightmos/lightmos-sdk/x/upgrade/plan"
...
func NewCmdSubmitLegacyUpgradeProposal() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long: "Submit a software upgrade along with an initial deposit.\n" +
			...
			"You may include info to reference a binary download link, in a format compatible with: https://github.com/lightmos/lightmos-sdk/tree/main/cosmovisor",
