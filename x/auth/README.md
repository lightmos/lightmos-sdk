...
The `AnteHandler` can be seen as a set of decorators that check transactions within the current context, per [ADR 010](https://github.com/lightmos/lightmos-sdk/blob/main/docs/architecture/adr-010-modular-antehandler.md).
