...
type WeightedVoteOption struct {
	...
	Weight github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=weight,proto3,customtype=github.com/lightmos/lightmos-sdk/types.Dec" json:"weight"`
}
...
type Deposit struct {
	...
	Amount github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,3,rep,name=amount,proto3,castrepeated=github.com/lightmos/lightmos-sdk/types.Coins" json:"amount"`
}
...
type Proposal struct {
	...
	TotalDeposit github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,7,rep,name=total_deposit,json=totalDeposit,proto3,castrepeated=github.com/lightmos/lightmos-sdk/types.Coins" json:"total_deposit"`
...
type TallyResult struct {
	...
	Yes github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,1,opt,name=yes,proto3,customtype=github.com/lightmos/lightmos-sdk/types.Int" json:"yes"`
	// abstain is the number of abstain votes on a proposal.
	Abstain github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,2,opt,name=abstain,proto3,customtype=github.com/lightmos/lightmos-sdk/types.Int" json:"abstain"`
	// no is the number of no votes on a proposal.
	No github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,3,opt,name=no,proto3,customtype=github.com/lightmos/lightmos-sdk/types.Int" json:"no"`
	// no_with_veto is the number of no with veto votes on a proposal.
	NoWithVeto github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,4,opt,name=no_with_veto,json=noWithVeto,proto3,customtype=github.com/lightmos/lightmos-sdk/types.Int" json:"no_with_veto"`
}
...
type DepositParams struct {
	...
	MinDeposit github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=min_deposit,json=minDeposit,proto3,castrepeated=github.com/lightmos/lightmos-sdk/types.Coins" json:"min_deposit,omitempty"`
...
type TallyParams struct {
	...
	// considered valid.
	Quorum github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,1,opt,name=quorum,proto3,customtype=github.com/lightmos/lightmos-sdk/types.Dec" json:"quorum,omitempty"`
	// Minimum proportion of Yes votes for proposal to pass. Default value: 0.5.
	Threshold github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=threshold,proto3,customtype=github.com/lightmos/lightmos-sdk/types.Dec" json:"threshold,omitempty"`
	// Minimum value of Veto votes to Total votes ratio for proposal to be
	// vetoed. Default value: 1/3.
	VetoThreshold github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=veto_threshold,json=vetoThreshold,proto3,customtype=github.com/lightmos/lightmos-sdk/types.Dec" json:"veto_threshold,omitempty"`
}
