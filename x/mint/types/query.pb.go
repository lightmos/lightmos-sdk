...
type QueryAnnualProvisionsResponse struct {
	...
	AnnualProvisions github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,1,opt,name=annual_provisions,json=annualProvisions,proto3,customtype=github.com/lightmos/lightmos-sdk/types.Dec" json:"annual_provisions"`
}
