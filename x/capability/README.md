...
`x/capability` is an implementation of a Cosmos SDK module, per [ADR 003](https://github.com/lightmos/lightmos-sdk/blob/main/docs/architecture/adr-003-dynamic-capability-store.md),
