...
type Params struct {
	CommunityTax github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,1,opt,name=community_tax,json=communityTax,proto3,customtype=github.com/lightmos/lightmos-sdk/types.Dec" json:"community_tax"`
	// Deprecated: The base_proposer_reward field is deprecated and is no longer used
	// in the x/distribution module's reward mechanism.
	BaseProposerReward github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=base_proposer_reward,json=baseProposerReward,proto3,customtype=github.com/lightmos/lightmos-sdk/types.Dec" json:"base_proposer_reward"` // Deprecated: Do not use.
	// Deprecated: The bonus_proposer_reward field is deprecated and is no longer used
	// in the x/distribution module's reward mechanism.
	BonusProposerReward github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=bonus_proposer_reward,json=bonusProposerReward,proto3,customtype=github.com/lightmos/lightmos-sdk/types.Dec" json:"bonus_proposer_reward"` // Deprecated: Do not use.
...
type ValidatorHistoricalRewards struct {
	CumulativeRewardRatio github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=cumulative_reward_ratio,json=cumulativeRewardRatio,proto3,castrepeated=github.com/lightmos/lightmos-sdk/types.DecCoins" json:"cumulative_reward_ratio"`
...
type ValidatorCurrentRewards struct {
	Rewards github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=rewards,proto3,castrepeated=github.com/lightmos/lightmos-sdk/types.DecCoins" json:"rewards"`
...
type ValidatorAccumulatedCommission struct {
	Commission github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=commission,proto3,castrepeated=github.com/lightmos/lightmos-sdk/types.DecCoins" json:"commission"`
}
...
type ValidatorSlashEvent struct {
	...
	Fraction        github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=fraction,proto3,customtype=github.com/lightmos/lightmos-sdk/types.Dec" json:"fraction"`
}
...
type FeePool struct {
	CommunityPool github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=community_pool,json=communityPool,proto3,castrepeated=github.com/lightmos/lightmos-sdk/types.DecCoins" json:"community_pool"`
}
...
type CommunityPoolSpendProposal struct {
	...
	Amount      github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,4,rep,name=amount,proto3,castrepeated=github.com/lightmos/lightmos-sdk/types.Coins" json:"amount"`
}
...
type DelegatorStartingInfo struct {
	...
	Stake          github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=stake,proto3,customtype=github.com/lightmos/lightmos-sdk/types.Dec" json:"stake"`
...
type DelegationDelegatorReward struct {
	...
	Reward           github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,2,rep,name=reward,proto3,castrepeated=github.com/lightmos/lightmos-sdk/types.DecCoins" json:"reward"`
}
