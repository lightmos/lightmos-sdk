...
type QueryValidatorDistributionInfoResponse struct {
	...
	SelfBondRewards github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,2,rep,name=self_bond_rewards,json=selfBondRewards,proto3,castrepeated=github.com/lightmos/lightmos-sdk/types.DecCoins" json:"self_bond_rewards"`
	// commission defines the commission the validator received.
	Commission github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,3,rep,name=commission,proto3,castrepeated=github.com/lightmos/lightmos-sdk/types.DecCoins" json:"commission"`
}
...
type QueryDelegationTotalRewardsResponse struct {
	...
	Total github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,2,rep,name=total,proto3,castrepeated=github.com/lightmos/lightmos-sdk/types.DecCoins" json:"total"`
}
...
type QueryCommunityPoolResponse struct {
	...
	Pool github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=pool,proto3,castrepeated=github.com/lightmos/lightmos-sdk/types.DecCoins" json:"pool"`
}
