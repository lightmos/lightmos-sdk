...
This document specifies the fee grant module. For the full ADR, please see [Fee Grant ADR-029](https://github.com/lightmos/lightmos-sdk/blob/main/docs/architecture/adr-029-fee-grant-module.md).
...
```protobuf reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/proto/cosmos/feegrant/v1beta1/feegrant.proto#L83-L93
```

`FeeAllowanceI` looks like:

```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/feegrant/fees.go#L9-L32
```
...
```protobuf reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/proto/cosmos/feegrant/v1beta1/feegrant.proto#L15-L28
```
...
```protobuf reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/proto/cosmos/feegrant/v1beta1/feegrant.proto#L34-L68
```
...
```protobuf reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/proto/cosmos/feegrant/v1beta1/feegrant.proto#L70-L81
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/client/cmd.go#L249-L260
```

```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/client/tx/tx.go#L109-L109
```

```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/auth/tx/builder.go#L275-L284
```

```protobuf reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/proto/cosmos/tx/v1beta1/tx.proto#L203-L224
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/feegrant/feegrant.pb.go#L222-L230
```
...
```protobuf reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/proto/cosmos/feegrant/v1beta1/tx.proto#L25-L39
```
...
```protobuf reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/proto/cosmos/feegrant/v1beta1/tx.proto#L41-L54
```
