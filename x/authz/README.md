...
`x/authz` is an implementation of a Cosmos SDK module, per [ADR 30](https://github.com/lightmos/lightmos-sdk/blob/main/docs/architecture/adr-030-authz-module.md), that allows
...
on behalf of one account to other accounts. The design is defined in the [ADR 030](https://github.com/lightmos/lightmos-sdk/blob/main/docs/architecture/adr-030-authz-module.md).
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/authz/authorizations.go#L11-L25
```
...
```protobuf reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/proto/cosmos/authz/v1beta1/authz.proto#L14-L22
```

```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/authz/generic_authorization.go#L16-L29
```
...
```protobuf reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/proto/cosmos/bank/v1beta1/authz.proto#L11-L30
```

```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/bank/types/send_authorization.go#L29-L62
```
...
```protobuf reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/proto/cosmos/staking/v1beta1/authz.proto#L11-L35
```

```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/staking/types/authz.go#L15-L35
```
...
```protobuf reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/proto/cosmos/authz/v1beta1/authz.proto#L24-L32
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/5f4ddc6f80f9707320eec42182184207fff3833a/x/authz/keeper/keeper.go#L378-L403
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/authz/keeper/keys.go#L77-L93
```
...
```protobuf reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/proto/cosmos/authz/v1beta1/tx.proto#L35-L45
```
...
```protobuf reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/proto/cosmos/authz/v1beta1/tx.proto#L69-L78
```
...
```protobuf reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/proto/cosmos/authz/v1beta1/tx.proto#L52-L63
```
