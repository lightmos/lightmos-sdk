...
type GenesisState struct {
	...
	Supply github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,3,rep,name=supply,proto3,castrepeated=github.com/lightmos/lightmos-sdk/types.Coins" json:"supply"`
