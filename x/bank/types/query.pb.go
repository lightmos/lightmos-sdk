...
type QueryAllBalancesResponse struct {
	...
	Balances github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=balances,proto3,castrepeated=github.com/lightmos/lightmos-sdk/types.Coins" json:"balances"`
...
type QueryTotalSupplyResponse struct {
	...
	Supply github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=supply,proto3,castrepeated=github.com/lightmos/lightmos-sdk/types.Coins" json:"supply"`
	// pagination defines the pagination in the response.
	//
	// Since: cosmos-sdk 0.43
	Pagination *query.PageResponse `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
