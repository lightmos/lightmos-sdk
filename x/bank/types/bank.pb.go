...
type Input struct {
	...
	Coins   github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,2,rep,name=coins,proto3,castrepeated=github.com/lightmos/lightmos-sdk/types.Coins" json:"coins"`
}
...
// Deprecated: Do not use.
type Supply struct {
	Total github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=total,proto3,castrepeated=github.com/lightmos/lightmos-sdk/types.Coins" json:"total"`
}
