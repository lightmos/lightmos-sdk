...
type MsgEditValidator struct {
	...
	// REF: #2373
	CommissionRate    *github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=commission_rate,json=commissionRate,proto3,customtype=github.com/lightmos/lightmos-sdk/types.Dec" json:"commission_rate,omitempty"`
	MinSelfDelegation *github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,4,opt,name=min_self_delegation,json=minSelfDelegation,proto3,customtype=github.com/lightmos/lightmos-sdk/types.Int" json:"min_self_delegation,omitempty"`
}
