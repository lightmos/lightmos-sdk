...
enabling atomicy of operations ([currently a problem](https://github.com/lightmos/lightmos-sdk/issues/8030)). Any failure within a module-to-module call would result in a failure of the entire
transaction
...
[#7459](https://github.com/lightmos/lightmos-sdk/pull/7459#discussion_r529545528)).
...
and forms its address based on the `AddressHash` method from [the ADR-028](https://github.com/lightmos/lightmos-sdk/blob/main/docs/architecture/adr-028-public-key-addresses.md):
...
An alternative solution to internal-only methods could involve hooks / plugins as discussed [here](https://github.com/lightmos/lightmos-sdk/pull/7459#issuecomment-733807753).
...
inter-module router should also accept authorization middleware such as that provided by [ADR 030](https://github.com/lightmos/lightmos-sdk/blob/main/docs/architecture/adr-030-authz-module.md).
...
Cosmos SDK and could even be used for inter-module OCAPs as described in [\#5931](https://github.com/lightmos/lightmos-sdk/issues/5931).
...
* [ADR 030 draft](https://github.com/lightmos/lightmos-sdk/pull/7105)
