...
[ADR-053: Go Module Refactoring](https://github.com/lightmos/lightmos-sdk/blob/main/docs/architecture/adr-053-go-module-refactoring.md) expresses our desire for an SDK composed of many
independently versioned Go modules, and [ADR-057: App Wiring](https://github.com/lightmos/lightmos-sdk/blob/main/docs/architecture/adr-057-app-wiring.md) offers a methodology
for breaking apart inter-module dependencies through the use of dependency injection. As
described in [EPIC: Separate all SDK modules into standalone go modules](https://github.com/lightmos/lightmos-sdk/issues/11899), module
...
In [EPIC: Unit Testing of Modules via Mocks](https://github.com/lightmos/lightmos-sdk/issues/12398) it was thought this Gordian knot could be
...
Another point of confusion has been the current state of CLI test suites, [x/auth](https://github.com/lightmos/lightmos-sdk/blob/0f7e56c6f9102cda0ca9aba5b6f091dbca976b5a/x/auth/client/testutil/suite.go#L44-L49) for
...
CLI tests](https://github.com/lightmos/lightmos-sdk/issues/12696) identifies the ideal state of CLI tests using mocks, but does not address the
...
Example 1 journey vs illustrative tests - [depinject's BDD style tests](https://github.com/lightmos/lightmos-sdk/blob/main/depinject/features/bindings.feature), show how we can
rapidly build up many illustrative cases demonstrating behavioral rules without [very much
code](https://github.com/lightmos/lightmos-sdk/blob/main/depinject/binding_test.go) while maintaining high level readability.

Example 2 [depinject table driven tests](https://github.com/lightmos/lightmos-sdk/blob/main/depinject/provider_desc_test.go)

Example 3 [Bank keeper tests](https://github.com/lightmos/lightmos-sdk/blob/2bec9d2021918650d3938c3ab242f84289daef80/x/bank/keeper/keeper_test.go#L94-L105) - A mock implementation of `AccountKeeper` is
...
Wiring for integration tests is provided by `depinject` and some [helper code](https://github.com/lightmos/lightmos-sdk/blob/2bec9d2021918650d3938c3ab242f84289daef80/testutil/sims/app_helpers.go#L95) starts up
...
Example 1 [client/grpc_query_test/TestGRPCQuery](https://github.com/lightmos/lightmos-sdk/blob/2bec9d2021918650d3938c3ab242f84289daef80/client/grpc_query_test.go#L111-L129) - This test is misplaced in `/client`,
...
server without putting bytes on the wire through the use of [QueryServiceTestHelper](https://github.com/lightmos/lightmos-sdk/blob/2bec9d2021918650d3938c3ab242f84289daef80/baseapp/grpcrouter_helpers.go#L31).

Example 2 `x/evidence` Keeper integration tests - Starts up an application composed of [8
modules](https://github.com/lightmos/lightmos-sdk/blob/2bec9d2021918650d3938c3ab242f84289daef80/x/evidence/testutil/app.yaml#L1) with [5 keepers](https://github.com/lightmos/lightmos-sdk/blob/2bec9d2021918650d3938c3ab242f84289daef80/x/evidence/keeper/keeper_test.go#L101-L106) used in the integration test suite. One test in the suite
exercises [HandleEquivocationEvidence](https://github.com/lightmos/lightmos-sdk/blob/2bec9d2021918650d3938c3ab242f84289daef80/x/evidence/keeper/infraction_test.go#L42) which contains many interactions with the staking
keeper.

Example 3 - Integration suite app configurations may also be specified via golang (not
YAML as above) [statically](https://github.com/lightmos/lightmos-sdk/blob/main/x/nft/testutil/app_config.go) or [dynamically](https://github.com/lightmos/lightmos-sdk/blob/8c23f6f957d1c0bedd314806d1ac65bea59b084c/tests/integration/bank/keeper/keeper_test.go#L129-L134).
...
Modules must implement [AppModuleSimulation.WeightedOperations](https://github.com/lightmos/lightmos-sdk/blob/2bec9d2021918650d3938c3ab242f84289daef80/types/module/simulation.go#L31) to define their
...
* [A success](https://github.com/lightmos/lightmos-sdk/runs/7606931983?check_suite_focus=true) may take a long time to run, 7-10 minutes per simulation in CI.
* [Timeouts](https://github.com/lightmos/lightmos-sdk/runs/7606932295?check_suite_focus=true) sometimes occur on apparent successes without any indication why.
* Useful error messages not provided on [failure](https://github.com/lightmos/lightmos-sdk/runs/7606932548?check_suite_focus=true) from CI, requiring a developer to run
...
[tests/e2e](https://github.com/lightmos/lightmos-sdk/tree/main/tests/e2e) and rely on [testutil/network](https://github.com/lightmos/lightmos-sdk/tree/main/testutil/network) to start up an in-process Tendermint node.
...
When module unit test introduction as per [EPIC: Unit testing of modules via mocks](https://github.com/lightmos/lightmos-sdk/issues/12398)
...
demonstrated in [PR#12706](https://github.com/lightmos/lightmos-sdk/pull/12706).
...
A PoC `x/gov` was completed in PR [#12847](https://github.com/lightmos/lightmos-sdk/pull/12847)
