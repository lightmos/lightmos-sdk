...
* 2021 Feb 24: Remove mentions of `HybridCodec`, which has been abandoned in [#6843](https://github.com/lightmos/lightmos-sdk/pull/6843).
...
After [extension discussion](https://github.com/lightmos/lightmos-sdk/issues/6030),
...
```go
import "github.com/lightmos/lightmos-sdk/codec"
...
message MsgSubmitEvidence {
  bytes submitter = 1
    [
      (gogoproto.casttype) = "github.com/lightmos/lightmos-sdk/types.AccAddress"
    ];
...
1. https://github.com/lightmos/lightmos-sdk/issues/4977
2. https://github.com/lightmos/lightmos-sdk/issues/5444
