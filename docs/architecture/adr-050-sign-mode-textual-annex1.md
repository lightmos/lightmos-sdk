...
- Applies to:
  ...
  - strings whose `customtype` is `github.com/lightmos/lightmos-sdk/types.Int` or `github.com/lightmos/lightmos-sdk/types.Dec`
  - bytes whose `customtype` is `github.com/lightmos/lightmos-sdk/types.Int` or `github.com/lightmos/lightmos-sdk/types.Dec`
...
- Denoms are converted to `display` denoms using `Metadata` (if available). **This requires a state query**. The definition of `Metadata` can be found in the [bank Protobuf definition](https://github.com/lightmos/lightmos-sdk/blob/v0.46.0/proto/cosmos/bank/v1beta1/bank.proto#L79-L108). If the `display` field is empty or nil, then we do not perform any denom conversion.
