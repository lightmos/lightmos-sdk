...
delegated stake
* "sub-keys" functionality, as originally proposed in [\#4480](https://github.com/lightmos/lightmos-sdk/issues/4480) which
is a term used to describe the functionality provided by this module together with
the `fee_grant` module from [ADR 029](./adr-029-fee-grant-module.md) and the [group module](https://github.com/lightmos/lightmos-sdk/tree/main/x/group).
...
* B-Harvest subkeys spec: https://github.com/lightmos/lightmos-sdk/issues/4480
