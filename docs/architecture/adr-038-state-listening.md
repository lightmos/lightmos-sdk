...
Currently, KVStore data can be remotely accessed through [Queries](https://github.com/lightmos/lightmos-sdk/blob/master/docs/building-modules/messages-and-queries.md#queries)
