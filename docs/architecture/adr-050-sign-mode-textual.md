...
In an effort to remove Amino from the SDK, a new sign mode needs to be created for hardware devices. [Initial discussions](https://github.com/lightmos/lightmos-sdk/issues/6513) propose a text-based sign mode, which this ADR formally specifies.
...
- Initial discussion: https://github.com/lightmos/lightmos-sdk/issues/6513
