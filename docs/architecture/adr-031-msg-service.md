...
* 2021-04-21: Remove `ServiceMsg`s to follow Protobuf `Any`'s spec, see [#9063](https://github.com/lightmos/lightmos-sdk/issues/9063).
...
For instance, https://github.com/lightmos/lightmos-sdk/issues/7093 proposes a method for
...
(see [\#7093](https://github.com/lightmos/lightmos-sdk/issues/7093)):
...
evolve to satisfy the use cases discussed in [\#7093](https://github.com/lightmos/lightmos-sdk/issues/7093)
and [\#7122](https://github.com/lightmos/lightmos-sdk/issues/7421).
...
* communication interface is automatically generated, the developer can now focus only on the state transition methods - this would improve the UX of [\#7093](https://github.com/lightmos/lightmos-sdk/issues/7093) approach (1) if we chose to adopt that
...
* [Initial Github Issue \#7122](https://github.com/lightmos/lightmos-sdk/issues/7122)
