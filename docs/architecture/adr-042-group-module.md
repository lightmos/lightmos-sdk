...
* UX is cumbersome for non-technical users ([#5661](https://github.com/lightmos/lightmos-sdk/issues/5661)).
* It requires `legacy_amino` sign mode ([#8141](https://github.com/lightmos/lightmos-sdk/issues/8141)).
...
We propose merging the `x/group` module with its supporting [ORM/Table Store package](https://github.com/regen-network/regen-ledger/tree/master/orm) ([#7098](https://github.com/lightmos/lightmos-sdk/issues/7098)) into the Cosmos SDK and continuing development here. There will be a dedicated ADR for the ORM package.
...
The [ORM package](https://github.com/lightmos/lightmos-sdk/discussions/9156) defines tables, sequences and secondary indexes which are used in the group module.
...
* Convergence of `/group` and `x/gov` as both support proposals and voting: https://github.com/lightmos/lightmos-sdk/discussions/9066
...
* Initial specification:
    ...
    * [#5236](https://github.com/lightmos/lightmos-sdk/pull/5236)
* Proposal to add `x/group` into the Cosmos SDK: [#7633](https://github.com/lightmos/lightmos-sdk/issues/7633)
