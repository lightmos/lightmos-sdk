...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/Makefile#L411-L432
```

The script used to generate the protobuf files can be found in the `scripts/` directory. 

```shell reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/scripts/protocgen.sh#L1-L37
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/main/buf.work.yaml#L6-L9
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/main/proto/buf.gen.gogo.yaml#L1-L9
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/main/proto/buf.gen.pulsar.yaml#L1-L18
```
...
`buf.gen.swagger.yaml` generates the swagger documentation for the query and messages of the chain. This will only define the REST API end points that were defined in the query and msg servers. You can find examples of this [here](https://github.com/lightmos/lightmos-sdk/blob/main/proto/cosmos/bank/v1beta1/query.proto#L19)

```go reference
https://github.com/lightmos/lightmos-sdk/blob/main/proto/buf.gen.swagger.yaml#L1-L6
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/main/proto/buf.lock#L1-L16
```

#### `buf.yaml`

`buf.yaml` defines the [name of your package](https://github.com/lightmos/lightmos-sdk/blob/main/proto/buf.yaml#L3), which [breakage checker](https://docs.buf.build/tour/detect-breaking-changes) to use and how to [lint your protobuf files](https://docs.buf.build/tour/lint-your-api). 

```go reference
https://github.com/lightmos/lightmos-sdk/blob/main/proto/buf.yaml#L1-L24
```

We use a variety of linters for the Cosmos SDK protobuf files. The repo also checks this in ci. 

A reference to the github actions can be found [here](https://github.com/lightmos/lightmos-sdk/blob/main/.github/workflows/proto.yml#L1-L32)

```go reference
https://github.com/lightmos/lightmos-sdk/blob/main/.github/workflows/proto.yml#L1-L32
```
