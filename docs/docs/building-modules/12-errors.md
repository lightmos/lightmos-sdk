...
Registration of errors is handled via the [`errors` package](https://github.com/lightmos/lightmos-sdk/blob/main/errors/errors.go).

Example:

```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/distribution/types/errors.go#L1-L21
```
...
Note, the Cosmos SDK provides a core set of *common* errors. These errors are defined in [`types/errors/errors.go`](https://github.com/lightmos/lightmos-sdk/blob/main/types/errors/errors.go).
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/bank/keeper/keeper.go#L141-L182
```
