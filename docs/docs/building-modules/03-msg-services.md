...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/bank/types/tx.pb.go#L550-L568
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/bank/keeper/msg_server.go#L15-L17
```

`msgServer` methods can retrieve the `sdk.Context` from the `context.Context` parameter method using the `sdk.UnwrapSDKContext`:

```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/bank/keeper/msg_server.go#L28
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/baseapp/msg_service_router.go#L131
```
...
```protobuf reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/proto/cosmos/base/abci/v1beta1/abci.proto#L88-L109
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/auth/vesting/msg_server.go#L68-L80
```
