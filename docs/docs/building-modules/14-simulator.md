...
You can use the example [here](https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/distribution/simulation/decoder.go) from the distribution module to implement your store decoders.
...
You can check an example on how to create the randomized genesis [here](https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/staking/simulation/genesis.go).
...
You can see how an example of what is needed to fully test parameter changes [here](https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/staking/simulation/params.go)
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/staking/simulation/operations.go#L19-L86
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/Makefile#L293-L299
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/distribution/module.go#L180-L203
```
