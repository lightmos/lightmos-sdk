...
```protobuf reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/proto/cosmos/group/module/v1/module.proto
```
...
* Message fields define the module configuration.
  ...
  ```go reference
  https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/simapp/app_config.go#L226-L230
  ```

That message is generated using [`pulsar`](https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/scripts/protocgen-pulsar.sh) (by running `make proto-gen`).
In the case of the `group` module, this file is generated here: https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/api/cosmos/group/module/v1/module.pulsar.go.

The part that is relevant for the module configuration is:

```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/api/cosmos/group/module/v1/module.pulsar.go#L515-L527
```
...
1. Import the module configuration generated package:
  ...
  ```go reference
  https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/group/module/module.go#L12-L14
  ```
  ...
  ```go reference
  https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/group/module/module.go#L199-L204
  ```

2. Ensure that the module implements the `appmodule.AppModule` interface:

  ```go reference
  https://github.com/lightmos/lightmos-sdk/blob/v0.47.0/x/group/module/module.go#L58-L64
  ```
...
3. Define a struct that inherits `depinject.In` and define the module inputs (i.e. module dependencies):
  ...
  ```go reference
  https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/group/module/module.go#L206-L216
  ```
...
4. Define the module outputs with a public struct that inherits `depinject.Out`:
  ...
  ```go reference
  https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/group/module/module.go#L218-L223
  ```

5. Create a function named `ProvideModule` (as called in 1.) and use the inputs for instantiating the module outputs.

  ```go reference
  https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/group/module/module.go#L225-L235
  ```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/group/module/module.go#L195-L235
```
