...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/types/invariant.go#L9
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/staking/keeper/invariants.go#L12-L22
```

For more, see an example of [`Invariant`s implementation from the `staking` module](https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/staking/keeper/invariants.go).
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/types/invariant.go#L14-L17
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/crisis/keeper/keeper.go#L57-L61
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/crisis/abci.go#L12-L21
```
