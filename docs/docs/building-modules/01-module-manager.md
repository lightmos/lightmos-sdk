...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/types/module/module.go#L49-L59
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/types/module/module.go#L61-L66
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/types/module/module.go#L68-L72
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/types/module/module.go#L156-L160
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/types/module/module.go#L162-L167
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/types/module/module.go#L169-L173
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/types/module/module.go#L175-L179
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/types/module/module.go#L181-L185
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/types/module/module.go#L187-L194
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/types/module/module.go#L196-L200
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/types/module/module.go#L202-L206
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/types/module/module.go#L74-L84
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/types/module/module.go#L246-L273
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/simapp/app.go#L386-L432
```

This is the same example from `runtime` (the package that powers app v2):

```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/runtime/module.go#L77
```

```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/runtime/module.go#L87
```
