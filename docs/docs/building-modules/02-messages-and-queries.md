...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/types/tx_msg.go#L14-L26
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/auth/migrations/legacytx/stdsign.go#L20-L36
```

See an example implementation of a `message` from the `gov` module:

```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/gov/types/v1/msgs.go#L121-L153
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/baseapp/abci.go#L881-L902
```
