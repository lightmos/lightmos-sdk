...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/staking/keeper/keeper.go#L23-L31
```
...
For more, see an example of `keeper`'s [methods implementation from the `staking` module](https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/staking/keeper/keeper.go).
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/auth/keeper/account.go#L94-L108
```
