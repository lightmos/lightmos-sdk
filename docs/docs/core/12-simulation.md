...
On the Cosmos SDK, this functionality is provided by [`SimApp`](https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/simapp/app_v2.go), which is a
`Baseapp` application that is used for running the [`simulation`](https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/simulation) module.
...
Check the full list of flags [here](https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/simulation/client/cli/flags.go#L33-L57).
...
3. From a `params.json` file where the initial state is pseudo-randomly generated but the module and simulation parameters can be provided manually.
   ...
   The list of available parameters are listed [here](https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/simulation/client/cli/flags.go#L59-L78).
...
check the Cosmos SDK [Makefile](https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/Makefile#L282-L318).

```bash
 $ go test -mod=readonly github.com/lightmos/lightmos-sdk/simapp \
...
* Try adding logs to operations that are not logged. You will have to define a
  [Logger](https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/staking/keeper/keeper.go#L65-L68) on your `Keeper`.
