...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/store/types/store.go#L15-L18
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/store/types/store.go#L260-L284
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/store/types/store.go#L28-L33
```

The `Committer` is an interface that defines methods to persist changes to disk:

```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/store/types/store.go#L20-L27
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/store/types/store.go#L101-L133
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/store/types/store.go#L141-L200
```

As for concrete implementation, the [`rootMulti.Store`] is the go-to implementation of the `CommitMultiStore` interface.

```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/store/rootmulti/store.go#L53-L77
```
...
Whenever the `rootMulti.Store` needs to be branched, a [`cachemulti.Store`](https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/store/cachemulti/store.go) is used.

```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/store/cachemulti/store.go#L19-L33
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/store/types/store.go#L206-L239
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/bank/keeper/view.go#L115-L132
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/store/iavl/store.go#L37-L41
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/store/dbadapter/store.go#L13-L16
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/store/transient/store.go#L16-L19
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/params/types/subspace.go#L21-L31
```

Transient stores are typically accessed via the [`context`](./02-context.md) via the `TransientStore()` method:

```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/types/context.go#L284-L287
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/store/cachekv/store.go#L26-L36
```
...
Cosmos SDK applications use [`gas`](../basics/04-gas-fees.md) to track resources usage and prevent spam. [`GasKv.Store`](https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/store/gaskv/store.go) is a `KVStore` wrapper that enables automatic gas consumption each time a read or write to the store is made. It is the solution of choice to track storage usage in Cosmos SDK applications.

```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/store/gaskv/store.go#L11-L17
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/store/types/gas.go#L219-L228
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/types/context.go#L279-L282
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/store/types/gas.go#L230-L241
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/store/tracekv/store.go#L20-L43
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/store/prefix/store.go#L15-L21
```
...
Additional information about state streaming configuration can be found in the [store/streaming/README.md](https://github.com/lightmos/lightmos-sdk/tree/v0.47.0-rc1/store/streaming).

```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/store/listenkv/store.go#L11-L18
```
