...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/server/types/app.go#L46-L48
```
...
```protobuf reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/proto/cosmos/bank/v1beta1/query.proto#L23-L30
```
...
The Cosmos SDK's [Swagger generation script](https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/scripts/protoc-swagger-gen.sh) is a good place to start.
