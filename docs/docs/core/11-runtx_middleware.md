...
More context can found in the corresponding [ADR-022](../architecture/adr-022-custom-panic-handling.md) and the implementation in [recovery.go](https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/baseapp/recovery.go).

## Interface

```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/baseapp/recovery.go#L11-L14
```
