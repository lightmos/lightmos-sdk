...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/types/config.go#L14-L29
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/simapp/simd/main.go
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/server/start.go#L220
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/simapp/simd/cmd/root.go#L254-L268
```

Then, the instance of `app` is used to instantiate a new CometBFT node:

```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/server/start.go#L336-L348
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/server/start.go#L350-L352
```
