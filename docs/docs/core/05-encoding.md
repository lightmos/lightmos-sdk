...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/types/tx_msg.go#L76-L80
```

A standard implementation of both these objects can be found in the [`auth/tx` module](../modules/auth/tx/README.md):

```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/auth/tx/decoder.go
```

```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/auth/tx/encoder.go
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/auth/types/account.go#L307-L330
```
...
* the [`Validator`](https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/staking/types/staking.pb.go#L340-L377) struct that contains information about a validator.
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/staking/types/validator.go#L41-L64
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/codec/types/interface_registry.go#L24-L57
```
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/codec/yaml.go#L8-L20
```

For example:

```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/auth/types/account.go#L141-L151
```
