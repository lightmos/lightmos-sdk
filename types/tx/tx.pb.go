...
import (
	...
	types1 "github.com/lightmos/lightmos-sdk/crypto/types"
	...
	signing "github.com/lightmos/lightmos-sdk/types/tx/signing"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type TxBody struct {
	...
	// but should be called `note` instead (see https://github.com/lightmos/lightmos-sdk/issues/9122).
...
type Fee struct {
	...
	Amount github_com_lightmos_lightmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=amount,proto3,castrepeated=github.com/lightmos/lightmos-sdk/types.Coins" json:"amount"`
...
func (m *Fee) GetAmount() github_com_lightmos_lightmos_sdk_types.Coins {
	if m != nil {
		return m.Amount
	}
	return nil
...
func (m *Tip) GetAmount() github_com_lightmos_lightmos_sdk_types.Coins {
	if m != nil {
		return m.Amount
	}
	return nil
...
var fileDescriptor_96d1575ffde80842 = []byte{
	...
	,
}
