...
const (
	Query_Params_FullMethodName            = "/cosmos.restaking.v1beta1.Query/Params"
	Query_SellOrderBook_FullMethodName     = "/cosmos.restaking.v1beta1.Query/SellOrderBook"
	Query_SellOrderBookAll_FullMethodName  = "/cosmos.restaking.v1beta1.Query/SellOrderBookAll"
	Query_BuyOrderBook_FullMethodName      = "/cosmos.restaking.v1beta1.Query/BuyOrderBook"
	Query_BuyOrderBookAll_FullMethodName   = "/cosmos.restaking.v1beta1.Query/BuyOrderBookAll"
	Query_DenomTrace_FullMethodName        = "/cosmos.restaking.v1beta1.Query/DenomTrace"
	Query_DenomTraceAll_FullMethodName     = "/cosmos.restaking.v1beta1.Query/DenomTraceAll"
	Query_ValidatorToken_FullMethodName    = "/cosmos.restaking.v1beta1.Query/ValidatorToken"
	Query_ValidatorTokenAll_FullMethodName = "/cosmos.restaking.v1beta1.Query/ValidatorTokenAll"
)
...
func (c *queryClient) ValidatorToken(ctx context.Context, in *QueryGetValidatorTokenRequest, opts ...grpc.CallOption) (*QueryGetValidatorTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ValidatorToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ValidatorTokenAll(ctx context.Context, in *QueryAllValidatorTokenRequest, opts ...grpc.CallOption) (*QueryAllValidatorTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ValidatorTokenAll_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) ValidatorToken(context.Context, *QueryGetValidatorTokenRequest) (*QueryGetValidatorTokenResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ValidatorToken not implemented")
}
func (UnimplementedQueryServer) ValidatorTokenAll(context.Context, *QueryAllValidatorTokenRequest) (*QueryAllValidatorTokenResponse, error) {
...
func _Query_ValidatorToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_ValidatorToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ValidatorTokenAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_ValidatorTokenAll_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
