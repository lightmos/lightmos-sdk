...
func init() {
	...
	md_CommissionRates = File_cosmos_restaking_v1beta1_restaking_proto.Messages().ByName("CommissionRates")
...
func (x *CommissionRates) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_restaking_v1beta1_restaking_proto_msgTypes[0]
...
func (x *fastReflection_CommissionRates) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.restaking.v1beta1.CommissionRates.rate":
		return x.Rate != ""
	case "cosmos.restaking.v1beta1.CommissionRates.max_rate":
		return x.MaxRate != ""
	case "cosmos.restaking.v1beta1.CommissionRates.max_change_rate":
		return x.MaxChangeRate != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.restaking.v1beta1.CommissionRates"))
		}
		panic(fmt.Errorf("message cosmos.restaking.v1beta1.CommissionRates does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_CommissionRates) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.restaking.v1beta1.CommissionRates does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_CommissionRates) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.restaking.v1beta1.CommissionRates.rate":
		panic(fmt.Errorf("field rate of message cosmos.restaking.v1beta1.CommissionRates is not mutable"))
	case "cosmos.restaking.v1beta1.CommissionRates.max_rate":
		panic(fmt.Errorf("field max_rate of message cosmos.restaking.v1beta1.CommissionRates is not mutable"))
	case "cosmos.restaking.v1beta1.CommissionRates.max_change_rate":
		panic(fmt.Errorf("field max_change_rate of message cosmos.restaking.v1beta1.CommissionRates is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.restaking.v1beta1.CommissionRates"))
		}
...
func (x *fastReflection_CommissionRates) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.restaking.v1beta1.CommissionRates", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cosmos_restaking_v1beta1_restaking_proto_init()
	md_Commission = File_cosmos_restaking_v1beta1_restaking_proto.Messages().ByName("Commission")
...
func (x *Commission) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_restaking_v1beta1_restaking_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Commission) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.restaking.v1beta1.Commission.commission_rates":
		return x.CommissionRates != nil
	case "cosmos.restaking.v1beta1.Commission.update_time":
		return x.UpdateTime != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.restaking.v1beta1.Commission"))
		}
		panic(fmt.Errorf("message cosmos.restaking.v1beta1.Commission does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Commission) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.restaking.v1beta1.Commission does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Commission) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.restaking.v1beta1.Commission", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cosmos_restaking_v1beta1_restaking_proto_init()
	md_Description = File_cosmos_restaking_v1beta1_restaking_proto.Messages().ByName("Description")
...
func (x *Description) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_restaking_v1beta1_restaking_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Description) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.restaking.v1beta1.Description.moniker":
		return x.Moniker != ""
	case "cosmos.restaking.v1beta1.Description.identity":
		return x.Identity != ""
	case "cosmos.restaking.v1beta1.Description.website":
		return x.Website != ""
	case "cosmos.restaking.v1beta1.Description.security_contact":
		return x.SecurityContact != ""
	case "cosmos.restaking.v1beta1.Description.details":
		return x.Details != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.restaking.v1beta1.Description"))
		}
		panic(fmt.Errorf("message cosmos.restaking.v1beta1.Description does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Description) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.restaking.v1beta1.Description does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Description) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.restaking.v1beta1.Description.moniker":
		panic(fmt.Errorf("field moniker of message cosmos.restaking.v1beta1.Description is not mutable"))
	case "cosmos.restaking.v1beta1.Description.identity":
		panic(fmt.Errorf("field identity of message cosmos.restaking.v1beta1.Description is not mutable"))
	case "cosmos.restaking.v1beta1.Description.website":
		panic(fmt.Errorf("field website of message cosmos.restaking.v1beta1.Description is not mutable"))
	case "cosmos.restaking.v1beta1.Description.security_contact":
		panic(fmt.Errorf("field security_contact of message cosmos.restaking.v1beta1.Description is not mutable"))
	case "cosmos.restaking.v1beta1.Description.details":
		panic(fmt.Errorf("field details of message cosmos.restaking.v1beta1.Description is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.restaking.v1beta1.Description"))
		}
...
func (x *fastReflection_Description) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.restaking.v1beta1.Description", d.FullName()))
	}
	panic("unreachable")
}
...
func (*CommissionRates) Descriptor() ([]byte, []int) {
	return file_cosmos_restaking_v1beta1_restaking_proto_rawDescGZIP(), []int{0}
}
...
func (*Commission) Descriptor() ([]byte, []int) {
	return file_cosmos_restaking_v1beta1_restaking_proto_rawDescGZIP(), []int{1}
}
...
func (*Description) Descriptor() ([]byte, []int) {
	return file_cosmos_restaking_v1beta1_restaking_proto_rawDescGZIP(), []int{2}
}
...
var File_cosmos_restaking_v1beta1_restaking_proto protoreflect.FileDescriptor

var file_cosmos_restaking_v1beta1_restaking_proto_rawDesc = []byte{
	0x0a, 0x28, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x72, 0x65, 0x73, 0x74, 0x61, 0x6b, 0x69,
	0x6e, 0x67, 0x2f, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x72, 0x65, 0x73, 0x74, 0x61,
	0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x18, 0x63, 0x6f, 0x73, 0x6d,
	...
	0x6f, 0x22, 0xac, 0x02, 0x0a, 0x0f, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	0x52, 0x61, 0x74, 0x65, 0x73, 0x12, 0x50, 0x0a, 0x04, 0x72, 0x61, 0x74, 0x65, 0x18, 0x01, 0x20,
	...
	0x63, 0x52, 0x04, 0x72, 0x61, 0x74, 0x65, 0x12, 0x57, 0x0a, 0x08, 0x6d, 0x61, 0x78, 0x5f, 0x72,
	0x61, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x3c, 0xc8, 0xde, 0x1f, 0x00, 0xda,
	...
	,
	...
	0x74, 0x61, 0x69, 0x6c, 0x73, 0x3a, 0x08, 0x98, 0xa0, 0x1f, 0x01, 0xe8, 0xa0, 0x1f, 0x01, 0x42,
	0xec, 0x01, 0x0a, 0x1c, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x72,
	0x65, 0x73, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31,
	0x42, 0x0e, 0x52, 0x65, 0x73, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67, 0x50, 0x72, 0x6f, 0x74, 0x6f,
...
var (
	file_cosmos_restaking_v1beta1_restaking_proto_rawDescOnce sync.Once
	file_cosmos_restaking_v1beta1_restaking_proto_rawDescData = file_cosmos_restaking_v1beta1_restaking_proto_rawDesc
)

func file_cosmos_restaking_v1beta1_restaking_proto_rawDescGZIP() []byte {
	file_cosmos_restaking_v1beta1_restaking_proto_rawDescOnce.Do(func() {
		file_cosmos_restaking_v1beta1_restaking_proto_rawDescData = protoimpl.X.CompressGZIP(file_cosmos_restaking_v1beta1_restaking_proto_rawDescData)
	})
	return file_cosmos_restaking_v1beta1_restaking_proto_rawDescData
}

var file_cosmos_restaking_v1beta1_restaking_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_cosmos_restaking_v1beta1_restaking_proto_goTypes = []interface{}{
	(*CommissionRates)(nil),       // 0: cosmos.restaking.v1beta1.CommissionRates
	(*Commission)(nil),            // 1: cosmos.restaking.v1beta1.Commission
	(*Description)(nil),           // 2: cosmos.restaking.v1beta1.Description
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_cosmos_restaking_v1beta1_restaking_proto_depIdxs = []int32{
	0, // 0: cosmos.restaking.v1beta1.Commission.commission_rates:type_name -> cosmos.restaking.v1beta1.CommissionRates
	3, // 1: cosmos.restaking.v1beta1.Commission.update_time:type_name -> google.protobuf.Timestamp
...
func init() { file_cosmos_restaking_v1beta1_restaking_proto_init() }
func file_cosmos_restaking_v1beta1_restaking_proto_init() {
	if File_cosmos_restaking_v1beta1_restaking_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cosmos_restaking_v1beta1_restaking_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cosmos_restaking_v1beta1_restaking_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cosmos_restaking_v1beta1_restaking_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cosmos_restaking_v1beta1_restaking_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cosmos_restaking_v1beta1_restaking_proto_goTypes,
		DependencyIndexes: file_cosmos_restaking_v1beta1_restaking_proto_depIdxs,
		MessageInfos:      file_cosmos_restaking_v1beta1_restaking_proto_msgTypes,
	}.Build()
	File_cosmos_restaking_v1beta1_restaking_proto = out.File
	file_cosmos_restaking_v1beta1_restaking_proto_rawDesc = nil
	file_cosmos_restaking_v1beta1_restaking_proto_goTypes = nil
	file_cosmos_restaking_v1beta1_restaking_proto_depIdxs = nil
}
