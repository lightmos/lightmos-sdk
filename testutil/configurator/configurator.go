	...
	return func(config *appConfig) {
		config.moduleConfigs["mint"] = &appv1alpha1.ModuleConfig{
			...
			GolangBindings: []*appv1alpha1.GolangBinding{
				{
					InterfaceType:  "github.com/lightmos/lightmos-sdk/x/mint/types/types.StakingKeeper",
					Implementation: "github.com/lightmos/lightmos-sdk/x/staking/keeper/*keeper.Keeper",
				},
			},
		}
	}
