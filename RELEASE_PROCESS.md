...
* Breaking changes in Protobuf definitions, as specified in [ADR-044](https://github.com/lightmos/lightmos-sdk/blob/main/docs/architecture/adr-044-protobuf-updates-guidelines.md).
...
* **State machine changes**.
* **Protobug-breaking changes**, as specified in [ADR-044](https://github.com/lightmos/lightmos-sdk/blob/main/docs/architecture/adr-044-protobuf-updates-       guidelines.md).
...
1. Check that the bug is either fixed or not reproducible in `main`. It is, in general, not appropriate to release bug fixes for stable releases without first testing them in `main`. Please apply the label [v0.43](https://github.com/lightmos/lightmos-sdk/milestone/26) to the issue.
