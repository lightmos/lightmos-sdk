...
`depinject` includes an expressive and composable [Configuration API](https://pkg.go.dev/github.com/lightmos/lightmos-sdk/depinject#Config).
...
`Keeper` dependencies between modules.  For example `x/bank` expects an [AccountKeeper](https://pkg.go.dev/github.com/lightmos/lightmos-sdk/x/bank/types#AccountKeeper) interface as [input to ProvideModule](https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/x/bank/module.go#L208-L260).
...
```go reference
https://github.com/lightmos/lightmos-sdk/blob/v0.47.0-rc1/simapp/app_v2.go#L219-L244
```
