...
```bash
go test -v --bench github.com/lightmos/lightmos-sdk/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/lightmos/lightmos-sdk/crypto/keys/mintkey
...
PASS
ok  	github.com/lightmos/lightmos-sdk/crypto/keys/mintkey	12.093s
```
